...
export const en = {
  ...
  softphone: {
    ...
    micPermissionError: 'Microphone access is required — allow it and try again',
    dismiss: 'Dismiss',
    ...
    transferConsult: 'Consult first',
    transferComplete: 'Complete transfer',
    transferConsulting: 'Consulting…',
    transferOriginalOnHold: 'On hold',
    addCall: 'Add call',
    addCallPlaceholder: 'Number to dial',
    addCallSend: 'Call',
    cancel: 'Cancel',
    stateTrying: 'Calling…',
  ...
  aiAgent: {
    ...
    fields: {
      ...
      greetingNamePlaceholder: 'Your business name',
      greetingNameHintWithName: 'Used in the call greeting (e.g. "Thanks for calling {name}").',
      ...
      faqEntry: 'Entry {index}',
      faqQuestion: 'Question',
      faqAnswer: 'Answer',
      faqQuestionLabel: 'FAQ entry {index} question',
      faqAnswerLabel: 'FAQ entry {index} answer',
      faqRemove: 'Remove',
    ...
    errors: {
      ...
      nameMaxLength: 'Name must be {max} characters or fewer.',
      personaNameMaxLength: 'Persona name must be {max} characters or fewer.',
      greetingNameMaxLength: 'Greeting name must be {max} characters or fewer.',
      instructionsMaxLength: 'Instructions must be {max} characters or fewer.',
  ...
  phoneNumberOrdering: {
    ...
    search: {
      ...
      subtitle: 'Find available phone numbers by entering an area code or ZIP code.',
  ...
  accountOnboarding: {
    ...
    numbers: {
      ...
      directoryListing: {
        ...
        selectPrompt: 'Select which number should be listed:',
        noneOption: 'None \u2014 skip directory listing',
        noDIDs: 'No eligible phone numbers to configure.',
        ...
        validation: {
          nameRequired: 'Business name is required for the directory listing.',
        },
      },
      overview: {
      ...
      order: {
        ...
        searchSubtitle: 'Find available numbers by entering an area code or ZIP code',
  ...
  onboardingPortal: {
    ...
    rates: {
      ...
      pendingNote: 'Rate changes take effect at the start of the next billing period.',
      taxesAndFees: 'Taxes and fees are additional.',
      notBilled: 'This account is not billed.',
      noRates: 'No rates are set for this account yet.',
