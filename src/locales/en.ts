...
export const en = {
  ...
  accountOnboarding: {
    ...
    sidebar: {
      ...
      businessDetailsDesc: 'Company info & address',
      teamMembers: 'Team Members',
      teamMembersDesc: 'Add your team',
      numberOptions: 'Number Options',
      numberOptionsDesc: 'Choose how to get numbers',
      numberSetup: 'Number Setup',
      numberSetupDesc: 'Configure your numbers',
      verification: 'Verification',
      verificationDesc: 'Verify number ownership',
      deviceAssignment: 'Device Assignment',
      deviceAssignmentDesc: 'Assign devices to users',
    },
    account: {
      title: 'Account Setup',
      subtitle: 'Configure your account details and add team members.',
      details: {
      ...
      users: {
        ...
        description: 'Add team members who will use the phone system.',
        nameLabel: 'Name',
    ...
    numbers: {
      ...
      overview: {
        ...
        requestNewDesc: 'Search and order new phone numbers for your account.',
        portExisting: 'Port Existing Numbers',
        portExistingDesc: 'Transfer your current phone numbers from another carrier.',
        phoneNumber: 'Phone Number',
        status: 'Status',
        source: 'Source',
      ...
      order: {
        ...
        searchSubtitle: 'Find phone numbers by area code, city & state, or ZIP code.',
        ...
        confirmSubtitle: 'Review the numbers you are about to order.',
        placeOrder: 'Place Order',
        placing: 'Placing Order...',
        ordering: 'Ordering...',
        statusTitle: 'Order Status',
        statusPending: 'Your order is being processed...',
        statusStalled:
          'Your order is still being processed. You can continue and check back later.',
